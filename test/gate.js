...
const TESTS = [
  ...
  't_intro_end.js',       // ...and the tour ENDS on its own last beat, never on the 100s safety net
  't_intro_route.js',     // ...and neither tour's route crosses a wall, desk or container
  ...
  't_store_cast.js',      // ...and every crew member wears their own face, not a hash-pool stand-in
  ...
  't_art_budget.js',      // the decoded art library must fit the Xbox, which it once did not

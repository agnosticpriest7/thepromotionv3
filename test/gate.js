...
const TESTS = [
  ...
  't_grocery_ladder.js',  // Save-Rite's own six rungs + the irreversible department branch         // the loadLevel seam, proved with one empty room; office default unchanged
